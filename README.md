...
**Full interaction profile — all 23 compounds plus reference inhibitors:** ([raw CSV](results/interaction_analysis/NDM1_interaction_residues.csv))
...
**Top 3 leads — *Trachyspermum ammi* (Ajwain):**

![Ajwain top 3 interactions](results/interaction_analysis/2d_interaction_ajwain_top3.png)

**Top 3 leads — *Plectranthus amboinicus* (Karpooravalli):**

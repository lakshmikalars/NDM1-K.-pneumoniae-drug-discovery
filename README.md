...
**Full interaction profile — all 23 compounds plus reference inhibitors:** ([raw CSV](results/interaction_analysis/NDM1_interaction_residues_all23.csv))
...
![Ajwain top 3 interactions](results/interaction_analysis/2d_interaction_ajwain_top3.png)

**Top leads — *Plectranthus amboinicus* (Karpooravalli):**

![Karpooravalli top interactions](results/interaction_analysis/2d_interaction_karpooravalli_top3.png)
...
**Pharmacokinetic & toxicity properties of the 7 lead compounds, compared against reference inhibitors:** ([raw CSV](results/NDM1_ADMET_top_leads.csv))
...
![Aromadendrene MD simulation](results/MDS_analysis/MD_simulation_aromadendrene.png)
...
![Dibenzamide MD simulation](results/MDS_analysis/MD_simulation_dibenzamide.png)
